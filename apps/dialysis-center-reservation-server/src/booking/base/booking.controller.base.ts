...
export class BookingControllerBase {
    ...
    return await this.service.createBooking({
      data: {
        ...
        healthcareProvider: data.healthcareProvider
          ? {
              connect: data.healthcareProvider,
            }
          : undefined,
      },
      select: {
  ...
  @common.Patch("/bookings/:id/complete")
  ...
  async CompleteBooking(
    ...
    return this.service.CompleteBooking(body);
  }
  ...
  @common.Get("/bookings/patient/:id")
  @swagger.ApiOkResponse({
    type: Booking,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async ViewBookingsForPatient(
    ...
    return this.service.ViewBookingsForPatient(body);
  }

  @common.Get("/bookings/day/:date")
  @swagger.ApiOkResponse({
    type: Booking,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async ViewDailyBookings(
    ...
    return this.service.ViewDailyBookings(body);
  }
}
