...
@InputType()
class BookingUpdateManyWithoutHealthcareProvidersInput {
...
export { BookingUpdateManyWithoutHealthcareProvidersInput as BookingUpdateManyWithoutHealthcareProvidersInput };
